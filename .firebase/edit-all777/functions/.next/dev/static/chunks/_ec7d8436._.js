...
;
;
function WaveformTrimmer({ file, mode, onTimeChange }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WaveformTrimmer.useEffect": ()=>{
            ...
            const wavesurfer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wavesurfer$2e$js$2f$dist$2f$wavesurfer$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
                ...
                waveColor: '#d1d5db',
                progressColor: mode === 'extract' ? '#3b82f6' : '#ef4444',
                cursorColor: mode === 'extract' ? '#3b82f6' : '#ef4444',
                barWidth: 2,
                barRadius: 3,
                height: 100,
                normalize: true,
            ...
            wavesurfer.on('ready', {
                "WaveformTrimmer.useEffect": ()=>{
                    ...
                    // Create an initial region for trimming (e.g., first 10 seconds or full duration)
                    const initialEnd = Math.min(audioDuration, 60);
                    regions.addRegion({
                        id: 'trim-region',
                        start: 0,
                        end: initialEnd,
                        color: mode === 'extract' ? 'rgba(59, 130, 246, 0.2)' : 'rgba(239, 68, 68, 0.2)',
                        drag: true,
                        resize: true
                    });
                    onTimeChange(0, initialEnd);
                }
            }["WaveformTrimmer.useEffect"]);
            regions.on('region-updated', {
                "WaveformTrimmer.useEffect": (region)=>{
                    onTimeChange(region.start, region.end);
                }
            }["WaveformTrimmer.useEffect"]);
            wavesurfer.on('play', {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "waveform-container bg-slate-50/50 rounded-2xl p-6 border border-slate-200",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "text-xs font-mono bg-white px-3 py-1 rounded-full border border-slate-200 text-slate-500 shadow-sm",
                        children: [
                            "Total: ",
                            formatTime(duration)
                        ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-between items-center text-[10px] text-slate-400 font-medium px-1",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        children: "0:00"
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "text-xs text-center text-slate-500 mt-4 flex items-center justify-center gap-1",
                children: [
                    ...
                    " Drag the blue area to select the segment you want to keep."
                ]
            }, void 0, true, {
                fileName: "[project]/src/components/WaveformTrimmer.tsx",
                lineNumber: 109,
...
_s(WaveformTrimmer, "A0MdfTDfZEU5eA18i5Pg+/yAObU=");
_c = WaveformTrimmer;
var _c;
...
//# sourceMappingURL=_ec7d8436._.js.map